...
if __name__ == '__main__':
    ...
    print("=" * 70)
    print(f"Server running on: https://0.0.0.0:5000")
    print(f"Access via localhost: https://localhost:5000")
    print(f"Access via network: https://<your-ip>:5000")
    print(f"API endpoints available at /api/*")
    print(f"NOTE: Using self-signed certificate - browsers will show security warnings")
    print("=" * 70)
